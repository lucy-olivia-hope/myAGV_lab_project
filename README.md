...
| Guide | Description |
|-------|-------------|
| [Day2/day2_Navigation_latest.md](Day2/day2_Navigation_latest.md) | Day 2 — latest real-robot Nav2 + AMCL command order |
...
├── Day2/
│   └── day2_Navigation_latest.md       ← Latest real-robot Nav2 + AMCL checklist
├── lab_guide/
