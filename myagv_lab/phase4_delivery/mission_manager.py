"""
myagv_lab/phase4_delivery/mission_manager.py
=============================================
Phase 4 — LLM-PDDL Mission Manager
...
-----
  ...
  # Real robot
  python3 -m myagv_lab.phase4_delivery.mission_manager --real \\
...
class MissionManager:
    ...
    def _banner(self) -> None:
        ...
        print()
        print("┌" + "═" * 58 + "┐")
        print("│  myAGV Lab — Phase 4: LLM-PDDL Mission Manager" + " " * 10 + "│")
        print("│" + "─" * 58 + "│")
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Phase 4 — LLM-PDDL Mission Manager",
